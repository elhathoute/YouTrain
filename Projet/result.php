    ...
    <footer style="background-color: rgb(188, 206, 248);">
        <div class="container mt-5 pt-5">
            <div class="d-flex flex-nowrap justify-content-center">
                <a href="#" style="color: black;"><i class='bx bxl-facebook fs-1 mx-2'></i></a>
                <a href="#" style="color: black;"><i class='bx bxl-twitter fs-1 mx-2' ></i></a>
                <a href="#" style="color: black;"><i class='bx bxl-instagram fs-1 mx-2' ></i></a>
                <a href="#" style="color: black;"><i class='bx bxl-youtube fs-1 mx-2' ></i></a>
                <a href="#" style="color: black;"><i class='bx bxl-whatsapp fs-1 mx-2' ></i></a>
            </div>
            <div>
                <div>
                    <p>YourTrain™ Voyages</p>
                   <a href=""> <p> Réserver et planifier </p></a>
                   <a href=""> <p> Gérer la réservation </p></a>
                </div>
            </div>
