    ...
    <section>
        ...
        <div class="container col-sm-11 col-md-8 col-lg-7 ">
            ...
            <?php
                ...
                foreach( voyage::searchvoyage() as $vo){
                    echo '
                    ...
                    <div class="card-header bg-white d-flex justify-content-between mt-2 mx-3 ">
                        <div class="text-center ">
                            ...
                            <p class="fst-italic ">'.dbcon::searchby('gares','id',$vo['id_gare_dep'])['nom'].'</p>
                        </div>
                        <div class="text-center mt-3 ">
                            <p class="fw-semibold ">Durée '.secsToStr($vo['date_dep'],$vo['date_arr']).'</p>
                        ...
                        <div class="text-center ">
                            ...
                            <p>'.$vo['date_arr'].'</p>
                            <p class="fst-italic ">'.dbcon::searchby('gares','id',$vo['id_gare_arr'])['nom'].'</p>
                        </div>
                    </div>
