...
<body>
    ...
    <div class="container pt-5">
        ...
        <div class="d-flex justify-content-between align-items-center pt-3">
            ...
            <div class="">
                <button onclick="edit()" type="submit" id="btnEdit" class="btn btn-outline-dark rounded-4"><span class="fw-normal" style=" font-size: 14px;">Modifier mon profil</span></button>
            </div>
        </div>
        <hr class="my-4">
    <div class="row ">
            ...
            <form action="" method="post" class=" mx-1 px-3 py-3 bg-white" style="border-radius: 10px 50px;">
                ...
                <div class="row g-3">
                    <div class="col-md-6 mt-5">
                        ...
                        <input type="text" class="form-control" id="nom"  style="border-color:rgb(32, 83, 117);" disabled>
                    </div>
                    <div class="col-md-6 mt-5">
                        <label for="prenom" class="form-label fw-semibold" style="color:rgb(32, 83, 117);">Mon Prènom</label>
                        <input type="text" class="form-control" id="prenom"  style="border-color:rgb(32, 83, 117);" disabled>
                    </div>
                    <div class="col-md-6 mt-5">
                        <label for="date" class="form-label fw-semibold" style="color:rgb(32, 83, 117);">Date de naissance</label>
                        <input type="date" class="form-control" id="date"  style="border-color:rgb(32, 83, 117);" disabled>
                    </div>
                    <div class="col-md-6 mt-5">
                        <label for="telephone" class="form-label fw-semibold" style="color:rgb(32, 83, 117);">Mon téléphone</label>
                        <input type="text" class="form-control" id="telephone"  style="border-color:rgb(32, 83, 117);" disabled>
                    </div>
                    <div class="col-md-12 mt-5">
                        <label for="Address" class="form-label fw-semibold" style="color:rgb(32, 83, 117);">Mon adresse</label>
                        <input type="text" class="form-control" id="Address" style="border-color:rgb(32, 83, 117);" disabled>
                    </div>
                    <div class="col-md-12 mt-5">
                        <label for="ville" class="form-label fw-semibold" style="color:rgb(32, 83, 117);" >Ma ville</label>
                        <input type="text" class="form-control" id="ville"  style="border-color:rgb(32, 83, 117);" disabled>
                    </div>
                    <div class="col-md-12 mt-5">
                        <label for="pays" class="form-label fw-semibold" style="color:rgb(32, 83, 117);" >Mon pays</label>
                        <input type="text" class="form-control" id="pays"  style="border-color:rgb(32, 83, 117);" disabled>
                    </div>
                    <div class="col-md-12 mt-5 mb-4">
                        <label for="profession" class="form-label fw-semibold" style="color:rgb(32, 83, 117);">Ma Profession</label>
                        <input type="text" class="form-control" id="profession"  style="border-color:rgb(32, 83, 117);" disabled>
                    </div>
            </form>
        </div>        
    </div>
        <div class="col-md-6">
            ...
            <form action="" id="" method="post" class="bg-white mx-1 px-3 py-3" style="border-radius: 10px 50px;">
                <div class="col-md-12 mt-2">
                    ...
                    <input type="text" class="form-control" id="identifiant"  style="border-color:rgb(32, 83, 117);" disabled>
                </div>
                <div class="col-md-12 mt-5">
                    <label for="email" class="form-label fw-semibold" style="color:rgb(32, 83, 117);">Mon e-mail</label>
                    <input type="email" class="form-control" id="email"  style="border-color:rgb(32, 83, 117);" disabled>
                </div>
        ...
        <div class="text-end py-3">
            <button type="submit" id="btnSave"  class="btn btn-outline-success w-15 fw-semibold" disabled>Enregistrer</button>
        </div>
    </div>
    </section>
    <?php
